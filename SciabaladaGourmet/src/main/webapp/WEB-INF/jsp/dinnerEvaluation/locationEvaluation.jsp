	...
	<head>
		...
		<script type="text/javascript">
			function createNumberCell(number) {
				...
				document.write("<td align=\"center\" width=\"22.75%\" bgcolor=\""+colors[numRandom]+"\"><a href=\"../saveLocationEvaluation/${id},"+number+"\"><H0W>"+number+"</H0W></a></td>");
			}
		</script>
	</head>
	<body>
		...
		<table style="width:100%">
			...
			<tr>
				...
				<td align="center"><H1W>Location</H1W></td>
		</table>  
